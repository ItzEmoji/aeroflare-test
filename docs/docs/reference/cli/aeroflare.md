...
* [aeroflare configure](aeroflare_configure.md)	 - Configure the remote cache (writes to the OCI manifest)
...
* [aeroflare settings](aeroflare_settings.md)	 - Configure local preferences (theme, logins, cache URL)
