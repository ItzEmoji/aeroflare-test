...
func (b *R2Backend) PushReceipts(ctx context.Context, receipts []cacheindex.PushReceipt) error {
	...
	eg.SetLimit(cacheindex.WorkerLimit(b.cfg.Workers, 10))
